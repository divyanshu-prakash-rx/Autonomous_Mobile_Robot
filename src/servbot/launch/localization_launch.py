...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('servbot')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'map',
            default_value='/home/venkat_mohit/AMR_WS/src/servbot/maps/MAP.yaml',
        ...
        DeclareLaunchArgument(
            'params_file',
            default_value='/home/venkat_mohit/AMR_WS/src/servbot/config/nav2_params.yaml',
